...
export const SignUpForm: FC<SignUpFormProps> = ({ onSubmit, isLoading = false }) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            className={`w-full pl-10 pr-12 py-2.5 bg-gray-50 dark:bg-gray-800 border rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all dark:text-white disabled:opacity-50 disabled:cursor-not-allowed ${
